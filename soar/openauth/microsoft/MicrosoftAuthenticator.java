...
import soar.openauth.microsoft.model.request.MinecraftLoginRequest;
import soar.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import soar.openauth.microsoft.model.request.XboxLiveLoginProperties;
import soar.openauth.microsoft.model.request.XboxLoginRequest;
import soar.openauth.microsoft.model.response.MicrosoftRefreshResponse;
import soar.openauth.microsoft.model.response.MinecraftLoginResponse;
import soar.openauth.microsoft.model.response.MinecraftProfile;
import soar.openauth.microsoft.model.response.MinecraftStoreResponse;
import soar.openauth.microsoft.model.response.XboxLoginResponse;
